 ...
 */
extern __global__ void advanceLIFNeuronsDevice( int totalNeurons, int maxSynapses, int maxSpikes, const BGFLOAT deltaT, uint64_t simulationStep, float* randNoise, AllIFNeuronsProperties* allNeuronsProperties, AllSpikingSynapsesProperties* allSynapsesProperties, SynapseIndexMap* synapseIndexMapDevice, bool fAllowBackPropagation, int iStepOffset );
 ...
 *  @param[in] iStepOffset           Offset from the current simulation step.
 */
extern __global__ void advanceIZHNeuronsDevice( int totalNeurons, int maxSynapses, int maxSpikes, const BGFLOAT deltaT, uint64_t simulationStep, float* randNoise, AllIZHNeuronsProperties* allNeuronsProperties, AllSpikingSynapsesProperties* allSynapsesProperties, SynapseIndexMap* synapseIndexMapDevice, bool fAllowBackPropagation, int iStepOffset );
