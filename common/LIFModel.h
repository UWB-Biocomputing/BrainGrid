 ...
 * activity-dependent facilitation and depression. 
 * The model has two state variables: \f$r\f$ (the fraction of available synaptic efficacy), and
 * \f$u\f$ (the running value of utilization of synaptic efficacy) (Markram et al. 1998).
 *
 * \f[
 ...
 *
 * \f[
 *  u_{n+1} = u_n \cdot \mathrm{e}^{-\frac{\Delta t}{\tau_{facil}}} +
 *  U \cdot (1-u_n \cdot \mathrm{e}^{-\frac{\Delta t}{\tau_{facil}}})
 * \f]
 *
 ...
 * and facilitation after a spike, and \f$U\f$ is utilization of synaptic efficacy.
 *
