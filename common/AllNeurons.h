...
struct AllNeurons
{
    public:
        ...
        GPU_COMPAT_BOOL *hasFired; // used as a bool (must be int sized/cannot be bool because of incompatibility with AMP)
        ...
        // Any synapse connected to this neuron totals here:
        BGFLOAT *summation;
