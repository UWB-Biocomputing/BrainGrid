        ...
        max_synapses(max_synapses)
{
    ...
    deltaT = new PTIMEFLOAT[num_neurons];
    psr = new BGFLOAT*[num_neurons];
    decay = new BGFLOAT*[num_neurons];
    total_delay = new uint32_t*[num_neurons];
    delayQueue = new uint32_t**[num_neurons];
    delayIdx = new uint32_t*[num_neurons];
    ldelayQueue = new uint32_t*[num_neurons];
    ...
    for (int i = 0; i < num_neurons; i++) {
        ...
        deltaT[i] = new TIMEFLOAT[max_synapses];
        psr[i] = new BGFLOAT[max_synapses];
        decay[i] = new BGFLOAT[max_synapses];
        total_delay[i] = new uint32_t[max_synapses];
        delayQueue[i] = new uint32_t*[max_synapses];
        delayIdx[i] = new uint32_t[max_synapses];
        ldelayQueue[i] = new uint32_t[max_synapses];
