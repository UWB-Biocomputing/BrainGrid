 ...
 */
void AllIZHSpikingSynapses::allocSynapseDeviceStruct( void** allSynapsesDevice, const SimulationInfo *sim_info ) {
 ...
 */
void AllIZHSpikingSynapses::allocSynapseDeviceStruct( void** allSynapsesDevice, int num_neurons, int maxSynapsesPerNeuron ) {
 ...
 *  @param  maxSynapsesPerNeuron  Maximum number of synapses per neuron.
 */
void AllIZHSpikingSynapses::allocDeviceStruct( AllSpikingSynapsesDeviceProperties &allSynapses, int num_neurons, int maxSynapsesPerNeuron ) {
 ...
 *  @param  sim_info           SimulationInfo to refer from.
 */
void AllIZHSpikingSynapses::deleteSynapseDeviceStruct( void* allSynapsesDevice ) {
        AllSpikingSynapsesDeviceProperties allSynapses;
 ...
 *                             on device memory.
 */
void AllIZHSpikingSynapses::deleteDeviceStruct( AllSpikingSynapsesDeviceProperties& allSynapses ) {
        ...
        // at AllIZHSpikingSynapses deconstructor.
 ...
 *  @param  sim_info           SimulationInfo to refer from.
 */
void AllIZHSpikingSynapses::copySynapseHostToDevice( void* allSynapsesDevice, const SimulationInfo *sim_info ) { // copy everything necessary
 ...
 *  @param  maxSynapsesPerNeuron  Maximum number of synapses per neuron.
 */
void AllIZHSpikingSynapses::copySynapseHostToDevice( void* allSynapsesDevice, int num_neurons, int maxSynapsesPerNeuron ) { // copy everything necessary
        AllSpikingSynapsesDeviceProperties allSynapses;
 ...
 *  @param  maxSynapsesPerNeuron  Maximum number of synapses per neuron.
 */
void AllIZHSpikingSynapses::copyHostToDevice( void* allSynapsesDevice, AllSpikingSynapsesDeviceProperties& allSynapses, int num_neurons, int maxSynapsesPerNeuron ) { // copy everything necessary 
        BGSIZE max_total_synapses = maxSynapsesPerNeuron * num_neurons;
 ...
 *  @param  sim_info           SimulationInfo to refer from.
 */
void AllIZHSpikingSynapses::copySynapseDeviceToHost( void* allSynapsesDevice, const SimulationInfo *sim_info ) {
 ...
 *  @param  maxSynapsesPerNeuron  Maximum number of synapses per neuron.
 */
void AllIZHSpikingSynapses::copyDeviceToHost( AllSpikingSynapsesDeviceProperties& allSynapses, const SimulationInfo *sim_info ) {
 ...
 *  @param  sim_info           SimulationInfo to refer from.
 */
void AllIZHSpikingSynapses::copyDeviceSynapseCountsToHost(void* allSynapsesDevice, const SimulationInfo *sim_info)
{
        AllSpikingSynapsesDeviceProperties allSynapses;
 ...
 *  @param  sim_info           SimulationInfo to refer from.
 */
void AllIZHSpikingSynapses::copyDeviceSynapseSumIdxToHost(void* allSynapsesDevice, const SimulationInfo *sim_info)
{
        AllSpikingSynapsesDeviceProperties allSynapses;
 ...
 */
void AllIZHSpikingSynapses::setAdvanceSynapsesDeviceParams()
{
    setSynapseClassID();
}
 ...
 *  (see issue#137).
 */
void AllIZHSpikingSynapses::setSynapseClassID()
{
 ...
 */
void AllIZHSpikingSynapses::advanceSynapses(void* allSynapsesDevice, void* allNeuronsDevice, void* synapseIndexMapDevice, const SimulationInfo *sim_info)
{
