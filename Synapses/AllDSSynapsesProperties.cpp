...
// Default constructor
AllDSSynapsesProperties::AllDSSynapsesProperties() : AllSpikingSynapsesProperties()
{
    lastSpike = NULL;
    r = NULL;
    u = NULL;
...
AllDSSynapsesProperties::~AllDSSynapsesProperties()
{
 ...
 */
void AllDSSynapsesProperties::setupSynapsesProperties(const int num_neurons, const int max_synapses, SimulationInfo *sim_info, ClusterInfo *clr_info)
{
 ...
 *  Deallocate memories.
 */
void AllDSSynapsesProperties::cleanupSynapsesProperties()
{
    BGSIZE max_total_synapses = maxSynapsesPerNeuron * count_neurons;
