 ...
 */
CUDA_CALLABLE void AllDynamicSTDPSynapses::changePSR(const BGSIZE iSyn, const BGFLOAT deltaT, uint64_t simulationStep, IAllSynapsesProps* pISynapsesProps)
{
    AllDynamicSTDPSynapsesProps *pSynapsesProps = reinterpret_cast<AllDynamicSTDPSynapsesProps*>(pISynapsesProps);
