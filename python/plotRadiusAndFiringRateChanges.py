...
def plot(filename, Tsim, neuronTypes, radiiHistory, ratesHistory, starterNeurons, xloc, yloc):
    ...
    #-------------------------------------------------------------------------
    # fig_1: Plot radii and firing changes (combined)
    #-------------------------------------------------------------------------
    ...
    fig_1.legend((p1[0], p2[0], p3[0], p4[0], p5[0]), labels, loc='upper right')
    fig_1.savefig(basename + '_RFRC_fig_1.png')
 
    #-------------------------------------------------------------------------
    # fig_2: Plot radii and firing changes (starter neurons)
    #-------------------------------------------------------------------------
    fig_2 = plt.figure(figsize=(20,12))
    ax_2_1 = fig_2.add_subplot(2,1,1)    
    ...
    ax_2_2 = fig_2.add_subplot(2,1,2)
    ...
    fig_2.savefig(basename + '_RFRC_fig_2.png')
    
    #-------------------------------------------------------------------------
    # fig_3: Plot radii and firing changes (excitatory neurons)
    #-------------------------------------------------------------------------
    fig_3 = plt.figure(figsize=(20,12))
    ax_3_1 = fig_3.add_subplot(2,1,1)    
    ...
    ax_3_2 = fig_3.add_subplot(2,1,2)
    ...
    fig_3.savefig(basename + '_RFRC_fig_3.png')
    
    #-------------------------------------------------------------------------
    # fig_4: Plot radii and firing changes (inhibitory neurons)
    #-------------------------------------------------------------------------
    fig_4 = plt.figure(figsize=(20,12))
    ax_4_1 = fig_4.add_subplot(2,1,1)    
    ...
    ax_4_2 = fig_4.add_subplot(2,1,2)
    ...
    fig_4.savefig(basename + '_RFRC_fig_4.png')
    
    #-------------------------------------------------------------------------
    # fig_5: Plot radii and firing changes (edge neurons)
    #-------------------------------------------------------------------------
    fig_5 = plt.figure(figsize=(20,12))
    ax_5_1 = fig_5.add_subplot(2,1,1)    
    ...
    ax_5_2 = fig_5.add_subplot(2,1,2)
    ...
    fig_5.savefig(basename + '_RFRC_fig_5.png')
    
    #-------------------------------------------------------------------------
    # fig_6: Plot radii and firing changes (corner neurons)
    #-------------------------------------------------------------------------
    fig_6 = plt.figure(figsize=(20,12))
    ax_6_1 = fig_6.add_subplot(2,1,1)    
    ...
    ax_6_2 = fig_6.add_subplot(2,1,2)
    ...
    fig_6.savefig(basename + '_RFRC_fig_6.png')
