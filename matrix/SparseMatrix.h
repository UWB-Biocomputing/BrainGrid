...
class SparseMatrix: public Matrix {
	...
	struct Element {
		...
		/**
		 @brief Two Elements are equal if they have the same coordinates
		...
		/**
		 @brief Checks to see if Element is at particular coordinates
...
public:
	...
	/**
	 ...
	 location, then a zero value one is created.
	 @param r element row
