...
void LIFGPUModel::allocNeuronDeviceStruct( int count, int max_spikes ) {
	...
	HANDLE_ERROR( cudaMalloc( ( void ** ) &allNeuronsDevice, sizeof( AllIFNeurons ) ) );
...
void LIFGPUModel::copyNeuronHostToDevice( const AllIFNeurons& allNeuronsHost, int count ) { 
	AllIFNeurons allNeurons;
	HANDLE_ERROR( cudaMemcpy ( &allNeurons, allNeuronsDevice, sizeof( AllIFNeurons ), cudaMemcpyDeviceToHost ) );
...
void LIFGPUModel::copyNeuronDeviceToHost( AllIFNeurons& allNeuronsHost, int count ) {
	AllIFNeurons allNeurons;
	HANDLE_ERROR( cudaMemcpy ( &allNeurons, allNeuronsDevice, sizeof( AllIFNeurons ), cudaMemcpyDeviceToHost ) );
