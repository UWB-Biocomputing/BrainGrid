...
void IZHGPUModel::advanceNeurons(const SimulationInfo *sim_info)
{
    ...
    // Advance neurons ------------->
    advanceNeuronsDevice <<< blocksPerGrid, threadsPerBlock >>> ( neuron_count, g_simulationStep, sim_info->maxSynapsesPerNeuron, sim_info->deltaT, randNoise_d, (AllIZHNeurons *)m_allNeuronsDevice, m_allSynapsesDevice );
}
