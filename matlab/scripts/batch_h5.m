...
%       stateoutfile = ['tR_', num2str(tR, '%0.1f'),'--fE_', num2str(fE, '%1.2f')];
        ...
        % save figures
        fprintf('Saving figures fig1-fig7\n');
%         saveas(fig1a, [stateoutfile, '_fig1a.jpg']);
        %
        ...
        fprintf('Saving figures fig2a-fig2g\n');
        ...
        fprintf('Saving figures fig5a-fig5i\n');
        ...
        fprintf('Saving figures fig6a-fig6f\n');
