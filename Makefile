...
$(RNGDIR)/MersenneTwister_d.o: $(RNGDIR)/MersenneTwister_d.cu $(UTILDIR)/Global.h $(RNGDIR)/MersenneTwister_d.h
	nvcc -c -g -arch=sm_20 -rdc=true $(RNGDIR)/MersenneTwister_kernel.cu $(CGPUFLAGS) -I$(RNGDIR) -I$(COREDIR) -I$(MATRIXDIR) -o $(RNGDIR)/MersenneTwister_d.o
...
$(COREDIR)/GPUSpikingModel.o: $(COREDIR)/GPUSpikingModel.cu $(UTILDIR)/Global.h $(COREDIR)/GPUSpikingModel.h $(NEURONDIR)/AllIFNeurons.h $(SYNAPSEDIR)/AllSynapses.h $(COREDIR)/IModel.h  
	nvcc -c -g -arch=sm_20 -rdc=true $(COREDIR)/GPUSpikingModel.cu $(CGPUFLAGS) -I$(UTILDIR) -I$(COREDIR) -I$(NEURONDIR) -I$(SYNAPSEDIR) -I$(MATRIXDIR) -o $(COREDIR)/GPUSpikingModel.o

$(NEURONDIR)/AllSpikingNeurons_d.o: $(NEURONDIR)/AllSpikingNeurons_d.cu $(UTILDIR)/Global.h $(NEURONDIR)/AllSpikingNeurons.h
	nvcc -c -g -arch=sm_20 -rdc=true $(NEURONDIR)/AllSpikingNeurons_d.cu $(CGPUFLAGS) -I$(NEURONDIR) -I$(UTILDIR) -I$(MATRIXDIR) -o $(NEURONDIR)/AllSpikingNeurons_d.o

$(NEURONDIR)/AllIFNeurons_d.o: $(NEURONDIR)/AllIFNeurons_d.cu $(UTILDIR)/Global.h $(NEURONDIR)/AllIFNeurons.h
	nvcc -c -g -arch=sm_20 -rdc=true $(NEURONDIR)/AllIFNeurons_d.cu $(CGPUFLAGS) -I$(NEURONDIR) -I$(UTILDIR) -I$(MATRIXDIR) -o $(NEURONDIR)/AllIFNeurons_d.o

$(NEURONDIR)/AllLIFNeurons_d.o: $(NEURONDIR)/AllLIFNeurons_d.cu $(UTILDIR)/Global.h $(NEURONDIR)/AllLIFNeurons.h
	nvcc -c -g -arch=sm_20 -rdc=true $(NEURONDIR)/AllLIFNeurons_d.cu $(CGPUFLAGS) -I$(NEURONDIR) -I$(UTILDIR) -I$(MATRIXDIR) -o $(NEURONDIR)/AllLIFNeurons_d.o

$(NEURONDIR)/AllIZHNeurons_d.o: $(NEURONDIR)/AllIZHNeurons_d.cu $(UTILDIR)/Global.h $(NEURONDIR)/AllIZHNeurons.h
	nvcc -c -g -arch=sm_20 -rdc=true $(NEURONDIR)/AllIZHNeurons_d.cu $(CGPUFLAGS) -I$(NEURONDIR) -I$(UTILDIR) -I$(MATRIXDIR) -o $(NEURONDIR)/AllIZHNeurons_d.o

$(SYNAPSEDIR)/AllSpikingSynapses_d.o: $(SYNAPSEDIR)/AllSpikingSynapses_d.cu $(UTILDIR)/Global.h $(SYNAPSEDIR)/AllSpikingSynapses.h
	nvcc -c -g -arch=sm_20 -rdc=true $(SYNAPSEDIR)/AllSpikingSynapses_d.cu $(CGPUFLAGS) -I$(SYNAPSEDIR) -I$(UTILDIR) -I$(MATRIXDIR) -o $(SYNAPSEDIR)/AllSpikingSynapses_d.o

$(SYNAPSEDIR)/AllDSSynapses_d.o: $(SYNAPSEDIR)/AllDSSynapses_d.cu $(UTILDIR)/Global.h $(SYNAPSEDIR)/AllDSSynapses.h
	nvcc -c -g -arch=sm_20 -rdc=true $(SYNAPSEDIR)/AllDSSynapses_d.cu $(CGPUFLAGS) -I$(SYNAPSEDIR) -I$(UTILDIR) -I$(MATRIXDIR) -o $(SYNAPSEDIR)/AllDSSynapses_d.o

$(SYNAPSEDIR)/AllSTDPSynapses_d.o: $(SYNAPSEDIR)/AllSTDPSynapses_d.cu $(UTILDIR)/Global.h $(SYNAPSEDIR)/AllSTDPSynapses.h
	nvcc -c -g -arch=sm_20 -rdc=true $(SYNAPSEDIR)/AllSTDPSynapses_d.cu $(CGPUFLAGS) -I$(SYNAPSEDIR) -I$(UTILDIR) -I$(MATRIXDIR) -o $(SYNAPSEDIR)/AllSTDPSynapses_d.o
...
$(SYNAPSEDIR)/AllDynamicSTDPSynapses_d.o: $(SYNAPSEDIR)/AllDynamicSTDPSynapses_d.cu $(UTILDIR)/Global.h $(SYNAPSEDIR)/AllDynamicSTDPSynapses.h
	nvcc -c -g -arch=sm_20 -rdc=true $(SYNAPSEDIR)/AllDynamicSTDPSynapses_d.cu $(CGPUFLAGS) -I$(SYNAPSEDIR) -I$(UTILDIR) -I$(MATRIXDIR) -o $(SYNAPSEDIR)/AllDynamicSTDPSynapses_d.o

$(CONNDIR)/ConnGrowth_d.o: $(CONNDIR)/ConnGrowth_d.cu $(UTILDIR)/Global.h $(CONNDIR)/ConnGrowth.h
	nvcc -c -g -arch=sm_20 -rdc=true $(CONNDIR)/ConnGrowth_d.cu $(CGPUFLAGS) -I$(CONNDIR) -I$(UTILDIR) -I$(MATRIXDIR) -o $(CONNDIR)/ConnGrowth_d.o
...
$(INPUTDIR)/GpuSInputRegular.o: $(INPUTDIR)/GpuSInputRegular.cu $(INPUTDIR)/ISInput.h $(INPUTDIR)/GpuSInputRegular.h
	nvcc -c -g -arch=sm_20 -rdc=true $(INPUTDIR)/GpuSInputRegular.cu $(CGPUFLAGS) -I$(CUDADIR) -I$(COMMDIR) -I$(XMLDIR) -I$(INPUTDIR) -o $(INPUTDIR)/GpuSInputRegular.o

$(INPUTDIR)/GpuSInputPoisson.o: $(INPUTDIR)/GpuSInputPoisson.cu $(INPUTDIR)/ISInput.h $(INPUTDIR)/GpuSInputPoisson.h
	nvcc -c -g -arch=sm_20 -rdc=true $(INPUTDIR)/GpuSInputPoisson.cu $(CGPUFLAGS) -I$(CUDADIR) -I$(COMMDIR) -I$(XMLDIR) -I$(INPUTDIR) -o $(INPUTDIR)/GpuSInputPoisson.o
