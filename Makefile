...
LGPUFLAGS = -lstdc++ -Xcompiler="-pthread" -L$(CUDALIBDIR) -lcuda -lcudart
NVCCFLAGS =  -Xcompiler="-pthread" -g -arch=sm_35 -rdc=true -DDEBUG_OUT $(INCDIRS) -I/usr/local/cuda/samples/common/inc
