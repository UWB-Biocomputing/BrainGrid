...
int main()
{
	...
	
	{
		...
		XmlTest( "Query attribute: int as FLOAT", result, TIXML_SUCCESS );
		XmlTest( "Query attribute: int as FLOAT", (int)dVal, 1 );
		result = ele->QueryDoubleAttribute( "attr1", &dVal );
		XmlTest( "Query attribute: FLOAT as FLOAT", (int)dVal, 2 );
		result = ele->QueryIntAttribute( "attr1", &iVal );
		XmlTest( "Query attribute: FLOAT as int", result, TIXML_SUCCESS );
		XmlTest( "Query attribute: FLOAT as int", iVal, 2 );
