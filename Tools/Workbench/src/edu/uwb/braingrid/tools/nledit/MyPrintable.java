...
public class MyPrintable implements Printable, Pageable {
	...
	public MyPrintable(LayoutPanel layoutPanel) {
		this.layoutPanel = layoutPanel;
	}

	public MyPrintable(PageFormat pf, LayoutPanel layoutPanel) {
		this.pf = pf;
		this.layoutPanel = layoutPanel;
	}
	...
	public int print(Graphics g, PageFormat pf, int pageIndex)
		...
		if (pageIndex == 1) {
			...
			String msg = layoutPanel.getCtrlFrame().getStatisticalMsg(false);
