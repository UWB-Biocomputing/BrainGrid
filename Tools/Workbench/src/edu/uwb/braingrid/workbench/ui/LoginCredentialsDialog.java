...
public class LoginCredentialsDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(hostnameTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {hostnameLabel, passwordLabel, usernameLabel});

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {hostnameTextField, passwordField, usernameTextField});
     ...
     * @param modal - true if the dialog should have exclusive focus while
     ...
     * character array returned by PasswordField.getPassword is returned. After
     * the copy is retrieved, the caller should call clearPassword to set the
     * value maintained within the dialog password to null. For security
     * reasons, the array referenced by the returned value should be zeroed out
     * using java.util.Arrays.fill(password, '0') after it is no longer needed
     * and it should not be stored anywhere else.
     *
    ...
    public char[] getPassword() {
        return Arrays.copyOf(passwordField.getPassword(),
                passwordField.getPassword().length);
    }

    /**
     * Sets the data held by the password field to null. For security reasons,
     * this method should be called directly after a copy of the password is
     * retrieved.
     */
    ...
    /**
     * Indicates whether or the user selected the OK button in order to close
     * the dialog.
     *
     * @return True if the user clicked okay to close the dialog, otherwise
     * false. A true value indicates that the remote operation should proceed.
     */
    ...
    private void setMsg(String msg, String color) {
        msgLabel.setText("<html>Message: <span style=\"color:"
                + color + "\">" + msg + "</span></html>");
    }
    // </editor-fold>
