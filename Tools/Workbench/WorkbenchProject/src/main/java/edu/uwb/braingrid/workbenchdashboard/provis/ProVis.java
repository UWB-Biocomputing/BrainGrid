...
public class ProVis extends WorkbenchApp {
	...
	public ProVis() {
		...
		pro_vis_ctrl_ = new ProVisCtrl(vis_canvas_, canvas_pane_, adjust_force_slider_,stop_forces_,show_node_ids_,show_relationships_, show_legend_, choose_file_btn_);
