...
public class SystemConfig {
	...
	public static final HashMap<String, InputAnalyzer.InputType> TAG_NAME_INPUT_TYPE_MAPPING = new HashMap<String, InputAnalyzer.InputType>() {
	...
	public static final Document getAllParamsClassesDoc() throws Exception {
		return DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(getAllParamsClassesFilePath());
	}
}
